...
self.addEventListener('fetch', e => {
  ...
  if (url.pathname.startsWith('/api/') || url.pathname.startsWith('/.netlify/') || url.pathname.startsWith('/teacher') || url.hostname.includes('identity.netlify.com')) return;
